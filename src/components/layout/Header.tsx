    ...
    <header className="h-14 border-b border-slate-800 bg-slate-900/90 backdrop-blur px-4 flex items-center justify-between gap-4 z-40 relative">
      ...
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          className="hidden md:flex items-center gap-1.5 px-2.5 py-1 rounded bg-slate-800/80 hover:bg-slate-800 text-slate-400 hover:text-slate-200 text-xs border border-slate-700/60 transition cursor-pointer ml-2"
      ...
      {/* Right: Actions (Generate Plan, Validate, Prepare for Coding, Settings) */}
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          title="Generate AI_CONTEXT.md and export coding agent instructions"
        >
          <FileCode2 className="w-3.5 h-3.5 text-brand-400" />
          <span className="hidden lg:inline">Prepare for Coding</span>
        </button>
